...
public class CarRegistrationNumberTest {
	...
	public void testNullArgument() throws IllegalArgumentException, Exception {
	 ...
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testWrongFormat() throws IllegalArgumentException, Exception {
	...
	public void testDuplicateCrn() throws IllegalArgumentException, Exception {
